...
function getQuestions() {
    ...
    myRequest.onreadystatechange = function() {
        if (this.readyState === 4 && this.status === 200) {
            ...
            submitButton.onclick =  () => {
                ...
                checkedAnswer(theRightAnswer, questionsCount);
    ...
    myRequest.open("GET", "python.questions.json", true);
    myRequest.send();
}
...
function checkedAnswer (rAnswer, count) {
    ...
    console.log(`The Choosen Answer Is ${theChoosenAnswer}`); //here
